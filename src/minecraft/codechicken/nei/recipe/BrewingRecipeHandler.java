...
public class BrewingRecipeHandler extends TemplateRecipeHandler
{
	public class CachedBrewingRecipe extends CachedRecipe
	{
		...
		public boolean equals(Object obj) 
		{
			...
			return result.item.getItemDamage() == recipe2.result.item.getItemDamage() &&
					...
					NEIClientUtils.areStacksSameType(ingredient.item, recipe2.ingredient.item);
		}
	...
	{		
		...
		for(CachedBrewingRecipe recipe : apotions)
		{
			if(NEIClientUtils.areStacksSameType(recipe.ingredient.item, ingredient) || NEIClientUtils.areStacksSameType(recipe.precursorPotion.item, ingredient))
			{
				arecipes.add(recipe);
			}
		}
