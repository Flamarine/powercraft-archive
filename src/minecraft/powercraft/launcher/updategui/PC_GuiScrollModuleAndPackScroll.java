...
public class PC_GuiScrollModuleAndPackScroll extends PC_GuiScroll{
	...
	public void drawElement(int element, int par1, int par2, float par3) {
		...
		if(displayText!=null){
			...
			drawHorizontalLine(0, (this.width-8-width)/2-2, 6, 0xFFFFFFFF);
			drawHorizontalLine((this.width-8+width)/2+2, this.width-8, 6, 0xFFFFFFFF);
			drawCenteredString(fontRenderer, displayText, (this.width-8)/2, 1, 0xFFFFFFFF);
		}else if(element==0){
