 ...
 * variable. Any Variable or function which implements the LValueI can appear on
...
public class Assign extends PostfixMathCommand implements CallbackEvaluationI {
	...
	public Object evaluate(Node node, EvaluatorI pv) throws ParseException {
		if (node.jjtGetNumChildren() != 2) throw new ParseException("Assignment operator must have 2 operators.");
