...
import powercraft.weasel.jep.function.Add;
import powercraft.weasel.jep.function.Assign;
import powercraft.weasel.jep.function.Comparative;
import powercraft.weasel.jep.function.Cross;
import powercraft.weasel.jep.function.Divide;
import powercraft.weasel.jep.function.Dot;
import powercraft.weasel.jep.function.Ele;
import powercraft.weasel.jep.function.List;
import powercraft.weasel.jep.function.Logical;
import powercraft.weasel.jep.function.Modulus;
import powercraft.weasel.jep.function.Multiply;
import powercraft.weasel.jep.function.Not;
import powercraft.weasel.jep.function.Power;
import powercraft.weasel.jep.function.Subtract;
import powercraft.weasel.jep.function.UMinus;
