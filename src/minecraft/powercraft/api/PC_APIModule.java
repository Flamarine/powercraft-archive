	...
	static{
		try {
			...
			if(PC_LauncherUtils.isClient()){
				c = Class.forName("powercraft.api.PC_ClientProxy", true, PC_APIModule.class.getClassLoader());
			}else{
				c = Class.forName("powercraft.api.PC_CommonProxy", true, PC_APIModule.class.getClassLoader());
			}
		...
		try {
			Class<?>c;
			if(PC_LauncherUtils.isClient()){
				c = Class.forName("powercraft.api.PC_ClientPacketHandler", true, PC_APIModule.class.getClassLoader());
			}else{
				c = Class.forName("powercraft.api.PC_PacketHandler", true, PC_APIModule.class.getClassLoader());
			}
